...
ax.text(1.2, 2.3, rf'{a}*$\Delta$G$_{{\sf OH}}$', color=(0.8,0.8,0.8), fontsize=10)
ax.text(1.2, 2.1, rf'+{b} eV', color=(0.8,0.8,0.8), fontsize=10)
...
for m, metal in enumerate(metals):
    ...
    ax.text(1.2, 2.5, r'$\Delta$G$_{\sf OOH}$=', color=(0.8,0.8,0.8), fontsize=10)
    ax.text(1.2, 2.3, rf'{a}*$\Delta$G$_{{\sf OH}}$', color=(0.8,0.8,0.8), fontsize=10)    
    ax.text(1.2, 2.3, rf'+{b} eV', color=(0.8,0.8,0.8), fontsize=10)    
