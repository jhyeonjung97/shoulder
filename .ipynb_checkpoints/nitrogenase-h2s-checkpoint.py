...
def plot_pourbaix(entries, png_name):
    ...
    if 'cluster' in png_name:
        ...
        ax.text(13, -0.85, r"$\mathbf{E_{2}}$", fontsize=14, ha='center')
        ax.text(13, -1.20, r"$\mathbf{E_{3}}$", fontsize=14, ha='center')
        ax.text(13, -1.80, r"$\mathbf{E_{4}}$", fontsize=14, ha='center')
        ...
        ax.text(4.0, -1.6, r"$\mathbf{E_{4}}$", fontsize=14)
        ax.text(9.5, -1.6, r"$\mathbf{E_{v} + HS^{-}}$", fontsize=14)
