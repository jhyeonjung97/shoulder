...
for dir in dirs:
    ...
    if A == '1' and B == 'Fe':
        ...
        ax.text(6.2, overpotentials['onsetP'][2] - 0.74, 
        ...
        ax.text(6.2, overpotentials['onsetP'][3] - 0.98,
    ...
    plt.xlim(-1.0, 2.5)
    plt.legend(loc='upper left', bbox_to_anchor=(1.0, 0.98), # borderaxespad=17, 
               ncol=1, labelspacing=0.3, handlelength=2, fontsize=10,
               fancybox=True, shadow=True)
    # plt.legend(loc='lower left', bbox_to_anchor=(0.0, 1.02), # borderaxespad=17, 
