...
for dir in dirs:
    ...
    if A == '1' and B == 'Fe':
        ...
        ax.text(6.6, overpotentials['onsetP'][2] - 0.73, 
        ...
        ax.text(6.6, overpotentials['onsetP'][3] - 0.97,
