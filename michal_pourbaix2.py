...
for dir in dirs:
    ...
    ax.text(0.2, onsetpotential_oho - 0.45, f'$S_8 (*OH + *O): {overpotential_oho:.2f}$', color='darkorange', rotation=-9.5, fontsize=10)
    ax.text(0.2, onsetpotential_ooh - 0.45, f'$S_9 (*OOH): {overpotential_ooh:.2f}$', color='lime', rotation=-9.5, fontsize=10)
