...
pot_elements={'Li':'Li_sv', 'Na':'Na_pv', 'K':'K_sv', 'Ca':'Ca_sv', 'Sc':'Sc_sv', 'Ti':'Ti_sv', 'V':'V_sv', 'Cr':'Cr_pv', 'Mn':'Mn_pv', 'Ga':'Ga_d', 'Ge':'Ge_d', 'Rb': 'Rb_sv', 'Sr': 'Sr_sv', 'Y': 'Y_sv', 'Zr': 'Zr_sv', 'Nb': 'Nb_sv', 'Mo': 'Mo_sv', 'Tc': 'Tc_pv', 'Ru': 'Ru_pv', 'In': 'In_d', 'Sn': 'Sn_d', 'Cs': 'Cs_sv', 'Ba': 'Ba_sv', 'Pr': 'Pr_3', 'Nd': 'Nd_3', 'Pm': 'Pm_3', 'Sm': 'Sm_3', 'Eu': 'Eu_2', 'Gd': 'Gd_3', 'Tb': 'Tb_3', 'Dy': 'Dy_3', 'Ho': 'Ho_3', 'Er':'Er_3', 'Tm':'Tm_3', 'Yb':'Yb_2', 'Lu':'Lu_3', 'Hf':'Hf_pv', 'Ta':'Ta_pv', 'W':'W_sv', 'Tl':'Tl_d', 'Pb':'Pb_d', 'Bi':'Bi_d', 'Po': 'Po_d', 'Fr': 'Fr_sv', 'Ra': 'Ra_sv'}
